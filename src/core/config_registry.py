...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_THIRD_PARTY_API_URL": {
        "title": "Tushare Third-party API URL",
        "description": "Third-party Tushare proxy URL. Official Tushare keeps the built-in default and is used as fallback.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TUSHARE_THIRD_PARTY_TOKEN": {
        "title": "Tushare Third-party Token",
        "description": "Token for the third-party Tushare proxy. Stored separately from the official Tushare token.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "TIANTIAN_FUND_API_BASE_URL": {
        "title": "TiantianFundApi Base URL",
        "description": "Base URL for TiantianFundApi service used to fetch off-exchange fund NAV.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "SEARCH_SERPAPI_BODY_FETCH_ENABLED": {
        "title": "SerpAPI Body Fetch",
        "description": "Allow SerpAPI search to fetch and parse article body text when snippets are sparse. Disabled by default to reduce cloud memory spikes.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SEARCH_COMPREHENSIVE_INTEL_MAX_SEARCHES": {
        "title": "Comprehensive Intel Dimensions",
        "description": "Maximum number of dimensions searched by Agent comprehensive intelligence.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SEARCH_COMPREHENSIVE_INTEL_RESULTS_PER_DIMENSION": {
        "title": "Intel Results Per Dimension",
        "description": "Maximum visible search results returned to the Agent for each intelligence dimension.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_TOOL_PARALLELISM": {
        "title": "Agent Tool Parallelism",
        "description": "Maximum concurrent tool calls in one Agent tool batch. Lower values reduce memory spikes on small cloud containers.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TTFUND_APIKEY": {
        "title": "Tiantian Fund Skills API Key",
        "description": "API key for Tiantian Fund official Skills gateway. Used as basic fund product-data supplement; Yingmi is preferred for professional advisory analysis when configured.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "IWENCAI_API_KEY": {
        "title": "iWencai API Key",
        "description": "API key for iWencai Skills/OpenAPI. Currently used only for bank wealth product lookup and NAV retrieval.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "IWENCAI_BASE_URL": {
        "title": "iWencai Base URL",
        "description": "Base URL for iWencai OpenAPI calls.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": False,
        "default_value": "https://openapi.iwencai.com",
        "options": [],
        "validation": {},
        "display_order": 25,
    },
    "YINGMI_API_KEY": {
        "title": "Yingmi StarGate API Key",
        "description": "API key for Yingmi StarGate MCP/OpenAPI. Preferred professional engine for fund diagnosis, portfolio diagnosis, advisory strategy and wealth planning.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "YINGMI_ENABLED": {
        "title": "Enable Yingmi Advisory Engine",
        "description": "Enable Yingmi as the preferred professional analysis provider for fund/advisory workflows. When unavailable, existing local and Tiantian data flows remain as fallback.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "YINGMI_STARGATE_BASE_URL": {
        "title": "Yingmi StarGate Base URL",
        "description": "Base URL for Yingmi StarGate OpenAPI/MCP calls.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": False,
        "default_value": "https://stargate.yingmi.com/api",
        "options": [],
        "validation": {},
        "display_order": 28,
    },
    "YINGMI_FUND_ANALYSIS_DEPTH": {
        "title": "Fund Advisory Analysis Depth",
        "description": "Controls how many Yingmi professional tools are used for fund/advisory workflows. fast saves quota; professional is the default; deep adds more portfolio/risk/backtest style checks where applicable.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            {"label": "快速", "value": "fast"},
            {"label": "专业（推荐）", "value": "professional"},
            {"label": "深度", "value": "deep"},
        ],
        "validation": {"enum": ["fast", "professional", "deep"]},
        "display_order": 29,
    },
    "YINGMI_FUND_DATA_STRATEGY": {
        "title": "Fund Data Strategy",
        "description": "Controls provider preference for fund/advisory analysis. balanced prefers Yingmi for professional judgment and uses Tiantian/local data for facts; yingmi_only reduces non-Yingmi enrichment; basic_only skips Yingmi professional calls.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            {"label": "智能优先（推荐）", "value": "balanced"},
            {"label": "仅盈米专业判断", "value": "yingmi_only"},
            {"label": "仅基础数据", "value": "basic_only"},
        ],
        "validation": {"enum": ["balanced", "yingmi_only", "basic_only"]},
        "display_order": 30,
    },
    "YINGMI_MCP_DAILY_LIMIT": {
        "title": "Yingmi MCP Daily Limit",
        "description": "Daily Yingmi MCP/OpenAPI quota used for UI budgeting and future throttling.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "YINGMI_SKILL_DAILY_LIMIT": {
        "title": "Yingmi Skills Daily Limit",
        "description": "Daily Yingmi remote-skill quota kept visible for planning. Production flows currently use StarGate MCP/OpenAPI first.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_SKILLS": {
        "title": "Stock Agent Strategies",
        "description": "Comma-separated list of active stock-strategy skills. This controls stock ask-analysis strategy routing, not fund advisory providers.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_SKILL_DIR": {
        "title": "Stock Agent Strategy Dir",
        "description": "Directory containing stock strategy-skill definition files (YAML or SKILL.md bundles).",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_NL_ROUTING": {
        "title": "Bot Auto Route Stock Questions",
        "description": "Enable bot auto-routing for stock-like private chat or @mention messages. Web pages are not affected.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_ARCH": {
        "title": "Stock Agent Execution Mode",
        "description": "How stock Q&A runs. 'single' is simpler and cheaper; 'multi' uses multiple specialised agents and can be slower.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_ORCHESTRATOR_MODE": {
        "title": "Multi-Agent Analysis Depth",
        "description": "Only used when Stock Agent Execution Mode is multi. quick is fastest; standard adds intelligence; full adds risk; specialist adds strategy specialists.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_ORCHESTRATOR_TIMEOUT_S": {
        ...
        "description": "Maximum time for one stock Agent answer. Set to 0 to disable the timeout, which is not recommended for normal use.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_RISK_OVERRIDE": {
        "title": "Allow Risk Veto",
        "description": "When enabled, the risk agent can downgrade or veto buy conclusions if critical risks are found.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_DEEP_RESEARCH_BUDGET": {
        ...
        "description": "Maximum token budget for background deep research. Higher values may improve completeness but increase model cost.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_DEEP_RESEARCH_TIMEOUT": {
        "title": "Deep Research Timeout Seconds",
        "description": "Maximum time for a deep research request before returning a timeout or partial result.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "AGENT_MEMORY_ENABLED": {
        "title": "Analysis Memory Calibration",
        "description": "Track historical analysis performance and adjust future confidence. Leave off unless you intentionally use calibration.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_SKILL_AUTOWEIGHT": {
        "title": "Auto-Weight Stock Strategies",
        "description": "Automatically adjust stock-strategy weights by historical backtest performance.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_SKILL_ROUTING": {
        "title": "Stock Strategy Selection",
        "description": "auto lets the system pick strategies by market regime; manual only uses the configured stock strategy list.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "AGENT_EVENT_MONITOR_ENABLED": {
        "title": "Background Event Monitor",
        "description": "Enable background price/volume event monitoring in schedule mode.",
        "category": "agent",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "AGENT_EVENT_MONITOR_INTERVAL_MINUTES": {
        "title": "Event Monitor Interval Minutes",
        "description": "How often background event monitoring checks price/volume rules.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
