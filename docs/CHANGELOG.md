...
- [改进] 银行账户拆分活期、定期存款和银行理财三类录入，银行理财支持登记编码、份额、派息/滚存和手工净值维护。
- [改进] Web 银行资产录入支持从已有定期/理财持仓选择取出或赎回，定期按单笔流水区分同名产品，并将“理财净值”入口调整为“净值更新”下拉选择产品。
- [改进] Web 银行理财买入录入补充买入确认净值并同步保存为手工净值，同时明确银行流水日期、起息日和到期日的表单语义。
- [新功能] 持仓管理新增独立投顾账户，支持投顾组合与定投计划按金额记录投入、赎回和当前价值，并纳入全账户资产快照与资产分布。
- [改进] 投顾账户改为金额口径，支持投顾组合与定投计划两类产品流水，价值更新录入当前总价值，不再要求投顾产品份额和单位净值。
- [改进] Web 投顾流水录入区分新买入和后续投入，追加买入、定投投入、手动跟投和赎回均按产品类型选择既有产品，避免手输产品名生成重复持仓。
